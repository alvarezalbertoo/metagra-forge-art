  ...
  return (
    <>
      ...
      <motion.nav
        ...
        className="fixed top-0 left-0 right-0 z-[100] px-6 lg:px-[60px] h-[72px] flex items-center justify-between bg-mgbg border-b border-border shadow-sm"
      >
        <Link to="/" className="flex items-center gap-3">
          <img
            src={metagraLogo}
            alt="Metagra Group"
            className="h-12 lg:h-14 w-auto dark:brightness-100 brightness-90"
          />
        </Link>
