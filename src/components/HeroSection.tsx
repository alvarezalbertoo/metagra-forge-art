  ...
  return (
    <section className="relative h-screen min-h-[700px] flex items-center overflow-hidden">
      ...
      >
        ...
        >
          Acero<br />
          en <span className="text-outline-accent">Movimiento</span>
        </motion.h1>
        ...
        <motion.div variants={fadeUp} className="mt-11 flex flex-wrap gap-4 items-center">
          <Link
            to="/tecnologias"
            className="relative overflow-hidden font-head font-bold text-[0.85rem] tracking-[0.2em] uppercase px-9 py-4 bg-mgaccent text-foreground hover:-translate-y-0.5 transition-transform group"
          >
      ...
      >
        {[
          ...
          <div key={s.label} className="text-right">
            ...
            <div className="font-mono text-[0.65rem] tracking-[0.15em] uppercase text-mgmuted mt-1">
              {s.label}
            </div>
          </div>
        ))}
      ...
      >
        <div
          ...
          style={{
            background: "linear-gradient(to bottom, #e8620a, transparent)",
            animation: "scrollPulse 1.8s ease-in-out infinite",
          }}
        />
        <span className="font-mono text-[0.6rem] tracking-[0.2em] text-mgmuted" style={{ writingMode: "vertical-lr" }}>
          Scroll
        </span>
      </motion.div>
    </section>
