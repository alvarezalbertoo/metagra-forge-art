    ...
    () => ({
      España: [
        {
          ...
          value: "Amilaga, 22 — 20570 Bergara, Gipuzkoa",
        },
        {
          icon: Phone,
          label: t("contact.phone"),
          value: "+34 943 761 348",
      ...
      México: [
        ...
        },
        {
          icon: Globe,
          label: t("contact.international"),
          value: "México · Guanajuato · Apaseo el Grande",
        },
      ],
    }),
    [t]
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-12 lg:gap-20 items-start">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={revealVariants}>
          ...
          >
            {t("contact.title1")}
            <br />
            <span className="text-outline">{t("contact.title2")}</span>
          </h2>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={2} variants={revealVariants}>
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                {...register("mensaje")}
                placeholder={t("contact.mensajePh")}
